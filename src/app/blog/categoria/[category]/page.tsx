...
import { getPostsByCategory, getAllPosts } from '@/data/blog-posts'
...
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  return {
    title: `${categoryName} | Blog Shakira BR`,
    description: `Explore todos os posts sobre ${categoryName.toLowerCase()} no blog da Shakira BR. Conteúdo exclusivo e dicas valiosas.`,
    keywords: `${categoryName.toLowerCase()}, blog, shakira br, conteúdo exclusivo, dicas`,
    openGraph: {
      title: `${categoryName} | Blog Shakira BR`,
      description: `Explore todos os posts sobre ${categoryName.toLowerCase()} no blog da Shakira BR.`,
      url: categoryUrl,
      siteName: 'Shakira BR',
      type: 'website',
    },
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Explore todos os posts sobre {categoryName.toLowerCase()} no blog da Shakira BR.
            </p>
          </div>
        </div>
      </div>
